...
class RestaurantList extends Component {
    ...
    renderEmptyState () {
        return (
            <h2 className = "heading-tertiary">Hang tight! We are working on getting you the list of resturants for your search...</h2>
        )
    }
    ...
    renderRestaurantInfo () {
        ...
        const RestaruantList = this.state.results.map((result) => {
              return (   
                ...
                <img src = {result.image_url} alt = "" className = "RestaurantInfo__img" height="80" width="90"/>
